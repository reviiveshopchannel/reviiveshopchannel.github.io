...
var  UNUSED IN REVIIVE SHOP CUZ NO PAYMENTS   EC_ERROR_INVALID_PCPW         = -4074;  /* Parental control password doesn't match */
var EC_ERROR_PC_DISABLED          = -4075;  /* Parental control is not enabled */
var SKIP EULA CUZ IT CAUSES BUGS ON WII U LMAO EC_ERROR_EULA                 = -4076;  /* Customer has not agreed to EULA */
var  UNUSED IN REVIIVE SHOP CUZ NO PAYMENTS   EC_ERROR_AGE_RESTRICTED       = -4077;  /* Opration requires parental control password */
var  UNUSED IN REVIIVE SHOP CUZ NO PAYMENTS   EC_ERROR_POINTS_RESTRICTED    = -4078;  /* Opration requires parental control password */
var  UNUSED IN REVIIVE SHOP CUZ NO PAYMENTS   EC_ERROR_ALREADY_OWN          = -4079;  /* Attempt purchase already owned item */
var EC_ERROR_SHOP_SETUP           = -4080;  /* Shop channel setup not done or cleared */
var  UNUSED IN REVIIVE SHOP CUZ NO PAYMENTS  EC_ERROR_INSUFFICIENT_FUNDS   = -4081;  /* Not enough funds to purchase the item */
...
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_Starting                       =  1;
var EC_PHASE_Done                           =  2;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_PurchasingTitle                =  3;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_RedeemingECard                 =  4;  // deprecated
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_DownloadingContent             =  5;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_GettingTicketsFromServer       =  6;
var EC_PHASE_GettingPointsBalance           =  7;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_PurchasingPoints               =  8;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_CheckingRegistrationStatus     = 11;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_Registering                    = 12;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_Unregistering                  = 13;
var{UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PHASE_Transfer                       = 14;
var {UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM} EC_PHASE_DeletingOwnership              = 15;


var EC_INVALID_ACCOUNT_ID = "";


var {UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}  EC_PaymentMethod_ECard      = 0;
var {UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}   EC_PaymentMethod_Account    = 1;
var  {UNUSED IN REVIIVE SHOP CUZ NEW DOWNLOAD SYSTEMM}   EC_PaymentMethod_CreditCard = 2;
